...
//                ArrayList<ImportCompanyDTO> importCompanyDTOS = new ArrayList<>();
//                ObservableList<ImportCompantTM> importCompantTMS = FXCollections.observableArrayList();
//
//                for (ImportCompanyDTO importCompanyDTO : importCompanyDTOS){
//                    ImportCompantTM importCompantTM = new ImportCompantTM(
...
//
//                    importCompantTMS.add(importCompantTM);
//                }
//                tblImport.setItems(importCompantTMS);
//            }
//
